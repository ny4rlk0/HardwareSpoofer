[Defines]
  ...
  PLATFORM_NAME             = NyarlkoEfiSpooferPkg # The name of the platform.
  ...
  OUTPUT_DIRECTORY          = Build/NyarlkoEfiSpooferPkg
...
[Components]
  NyarlkoEfiSpooferPkg/NyarlkoEfiSpooferApplication.inf
